...
public class InitTest {
	...
	protected String appUrl= System.getProperty("user.dir") +"/src/main/resources/com/selendroid/apk/";
	...
	{
		FileInputStream fs = new FileInputStream(System.getProperty("user.dir") +"/src/main/resources/com/selendroid/config/config.properties");
	...
	public void openApplication() throws MalformedURLException
	{
		...
		PageFactory.initElements(new AppiumFieldDecorator(driver,
					Integer.parseInt(CONFIG.getProperty("FieldDecorator_Timeout")), TimeUnit.SECONDS), this);
		}
	}
